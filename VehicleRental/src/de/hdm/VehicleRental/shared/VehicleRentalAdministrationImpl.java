...
public class VehicleRentalAdministrationImpl extends RemoteServiceServlet {
	 ...
	 * @return 
	 */
	public Profile createProfile(String lastName, String email, String firstName) { 
		// TODO Auto-generated method
		return null;
	 }
	/**
	 ...
	 * @return 
	 */
	public Reservation createReservation(int reservationNumber, EDate date, int vehicleNumber, int profileID) { 
		// TODO Auto-generated method
		return null;
	 }
	/**
